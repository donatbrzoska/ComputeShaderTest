...
public class Texture2DSplitSeparateResultCalculator : Calculator
{
    ...
    public Texture2DSplitSeparateResultCalculator(int textureSize, int threadsX, int threadsY, Renderer renderer)
    ...
    {
        return "Texture2DSplitSeparateResult";
    }
